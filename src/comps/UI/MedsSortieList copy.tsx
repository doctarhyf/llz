...
type props = {
  onMedSortieSelected: (med: ISortieMed) => void;

  medssortief: ISortieMed[];
};

export default function MedsSortieList({
  onMedSortieSelected,
  medssortief,
}: props) {
  ...
  console.log(onMedSortieSelected);
  console.log(medssortief);
  console.log(setmedsf);
